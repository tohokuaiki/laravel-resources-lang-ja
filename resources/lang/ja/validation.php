...
return [
    ...
    */
    ...
    'date_equals' => ':attributeは:dateの日付と一致している必要があります。',
    ...
    'ends_with' => ':attributeは「:values」で終わっている必要があります。',
    'file'                 => ':attributeにはファイルを指定してください。',
    'filled'               => ':attributeには空でない値を指定してください。',
    'gt' => [
        'numeric' => ':attributeには:minより大きいの数値を指定してください。',
        'file'    => ':attributeには:min KBより大きいのファイルを指定してください。',
        'string'  => ':attributeには:min文字より大きいの文字列を指定してください。',
        'array'   => ':attributeには:min個より大きいの要素を持つ配列を指定してください。',
    ],
    'gte' => [
    ...
    'lt' => [
        'numeric' => ':attributeには:max未満の数値を指定してください。',
        'file'    => ':attributeには:max KB未満のファイルを指定してください。',
        'string'  => ':attributeには:max文字未満の文字列を指定してください。',
        'array'   => ':attributeには:max個未満の要素を持つ配列を指定してください。',
    ],
    'lte' => [
